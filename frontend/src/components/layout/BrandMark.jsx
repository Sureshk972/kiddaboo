 ...
 */
export default function BrandMark({ onDark = false }) {
  return (
    <div className="flex items-center gap-2">
      <div className={`${onDark ? 'bg-white/20' : 'bg-sage-light'} flex flex-col items-center justify-center gap-1 p-1.5 w-9 h-9`}>
      ...
      <h1
        ...
        style={{ fontFamily: "'Inter', sans-serif", color: onDark ? '#FFFFFF' : '#8B3FE0' }}
      >
        Kiddaboo
      </h1>
    </div>
