    ...
    <div className="flex flex-col gap-2 mt-3">
      ...
      {isGoing && (
        <Link
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition-all duration-150 cursor-pointer border bg-white text-taupe-dark border-cream-dark hover:border-sage no-underline"
          title="Session chat"
        >
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
